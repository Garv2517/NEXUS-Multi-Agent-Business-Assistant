...
class FoundryManagerRouter:
    ...
    ROUTER_INSTRUCTIONS = (
        ...
        "and the explicitly supported compound workflows. Sales and inventory refer to the unified "
        "external USA Toy Sales analytics dataset; HR refers to the separate internal synthetic people domain.\n\n"
        ...
        "Do not invent reorder levels for the external retail dataset.\n"
